...
module gke {
    ...
    gke_is_regional_cluster = var.gke_is_regional_cluster
    ...
    gke_enable_logging_service = var.gke_enable_logging_service
    gke_enable_monitoring_service = var.gke_enable_monitoring_service
    gke_enable_managed_prometheus = var.gke_enable_managed_prometheus
...
module pg {
    ...
    pg_is_zonal = var.pg_is_zonal
    pg_zone = var.pg_zone
    pg_secondary_zone = var.pg_secondary_zone
    pg_tier = var.pg_tier
    pg_disk_type = var.pg_disk_type
    pg_disk_size = var.pg_disk_size
    pg_deletion_protection_enabled = var.pg_deletion_protection_enabled
